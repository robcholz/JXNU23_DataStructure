...
void profiler_output(const std::function<bool()>& func) {
...
void profiler(bool (* func)(uint64_t, uint16_t)) {
	std::cout<<"Size: 10000 ";
	profiler_output([func]() -> bool {
		return func(10000, 1989);
	});
	std::cout<<"Size: 50000 ";
	profiler_output([func]() -> bool {
		return func(50000, 1989);
	});
	std::cout<<"Size: 100000 ";
	profiler_output([func]() -> bool {
		return func(100000, 1989);
	});
	std::cout<<"Size: 200000 ";
	profiler_output([func]() -> bool {
		return func(200000, 1989);
	});
	std::cout<<"Size: 300000 ";
	profiler_output([func]() -> bool {
		return func(300000, 1989);
	});
	std::cout<<"Size: 400000 ";
	profiler_output([func]() -> bool {
		return func(400000, 1989);
	});
	std::cout<<"Size: 500000 ";
	profiler_output([func]() -> bool {
		return func(500000, 1989);
	});
}
...
int main() {
	initArrayData(orderedStorage,
	              "~/test/data/ordered_50m.txt");
	initArrayData(disorderedStorage,
	              "~/test/data/disordered_50m.txt");
